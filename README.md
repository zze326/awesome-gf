...
- [zze-admin-go](https://github.com/zze326/zze-admin-go) - 一个基于 GoGrame v2.5.4 + Vue3 开发的前后端分离的后台管理系统脚手架，支持按钮级别的权限控制，使用前沿的前端技术（TypeScript、Pinia、Vite、Tailwind 等），易于二开；
